...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2022 at 02:27 AM
...
(3, 'Par defaut01', 2, 'Bas du corp', '1'),
...
(8, 'Par defaut01', 0, 'Bas du corp', '1'),
(9, 'Par defaut02', 0, 'haut1 du corp', '1'),
(13, 'asd', 0, 'das', 'asd'),
(14, 'Par defaut01', 0, 'Bas du corp', '1'),
(15, 'Par defaut02', 0, 'haut1 du corp', '1'),
(16, 'dsasd', 0, 'asd', 'sda'),
(17, 'asda', 0, 'dad', 'sda');
...
(1, 2, 'OPTIMUM NUTRITION - GOLD STANDARD WHEY', 'OPTIMUM NUTRITION', 84.99, '5lbs (2.7kg)', '', 'gold_whey.png'),
(2, 2, 'NUTRABOLICS - HYDROPURE', 'NUTRABOLICS', 39.99, '1.6lb(0.73g)', '', 'nutrabolic_whey.png'),
(3, 2, 'XPN - WHEY-X', 'XPN ', 20, '4.4lb(2kg)', '', 'xpn_whey.png'),
(4, 2, 'BELIEVE - FLAVORED WHEY', 'BELIEVE', 37.99, '2lb(0.91kg)', '', 'believe_whey.png'),
(5, 1, 'QUEST - BARRES PROTÉINÉES', 'QUEST', 3.99, '60 g', 'bar', 'questbar.png'),
(6, 3, 'Chandail Akatsuki Blanc', 'AkatsukiFitness', 20, 'Taille: M', 'Chandail de grande qualité', 'chandailblanc.png'),
(7, 3, 'Chandail Akatsuki Noir', 'AkatsukiFitness', 20, 'Taille : M', '', 'chandailnoir.png'),
(9, 3, 'Chandail Akatsuki Gris', 'AkatsukiFitness', 20, 'Taille: M', 'Chandail de qualité', 'chandailgris.png'),
(10, 5, 'Créatine', 'AkatsukiSupplement', 15, '200g', 'Créatine', 'creatine.png'),
(11, 5, 'Créatine', 'AkatsukiSupplement', 25, '500g', 'Créatine', 'creatine.png'),
(12, 3, 'Casquette', 'AkatsukiFitness', 12.99, 'Quantité: 1', 'Casquette', 'casquette.png'),
(15, 1, 'CARB KILLA BARRES DE PROTÉINES', 'GRENADE', 41.99, '60g', '', 'grenadebar.png'),
(16, 1, 'FEED BARS', 'NUTRABOLICS', 12, '200g', '', 'feedbar.png'),
(17, 6, 'YUMMY SPORTS - CANDIES BCAA', 'Yummy', 29.99, '210G', '', 'yummybcaa.png'),
(18, 7, 'MAMMOTH SUPPLEMENTS - MAMMOTH PUMP', 'MAMMOTH SUPPLEMENTS', 39.99, '270G', '', 'mammothpump.png'),
(20, 8, 'ALLMAX - QUICKMASS ', 'ALLMAX', 109.99, '12Lbs(5.44kg)', '', 'allmax_quickmass.png'),
(22, 8, 'MAMMOTH MASS', 'MAMMOTH SUPPLEMENTS', 39.99, '5lbs (2.7kg)', '', 'mammoth_mass.png'),
(23, 4, 'PERFECT SHAKER - CLASSIQUE BOTTLE', 'PERFECT SHAKER', 14.99, '28OZ', '', 'shaker_classic.png'),
(24, 4, 'Beyond Yourself SHAKER BOTTLE', 'Beyond Yourself ', 9.95, '700ml', '', 'shaker_beyond.png'),
(26, 4, 'BLENDER BOTTLE - MARVEL ', 'BLENDER BOTTLE', 19.99, '28OZ', '', 'shaker_blender.png');
...
(3, 'b', 'b', 'b@b', '2022-03-15', 0, NULL, NULL, NULL, NULL, 1),
(4, 'c', 'c', 'c@c', '2022-03-07', 0, NULL, '2022-03-10', '2022-06-10', NULL, 1);
...
--
ALTER TABLE `articlepanier`
  MODIFY `idarticle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `entrainement`
  MODIFY `identrainement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
