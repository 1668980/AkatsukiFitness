        ...
        <div class="card">
            <div class="flip-card">
                <div class="flip-card__container">
                    <div class="card-front">
                        <div class="card-front__tp card-front__tp--bronze">
                    ...
                    <p class="card-front__text-price">
                        ...
                        <div class="card-front__bt">
                            <p class="card-front__text-view card-front__text-view--bronze">
                                En savoir plus
                            </p>
                        </div>
                    </div>
                    <div class="card-back">
                        <img class="img__container" src="images/gifs/packBRONZE.gif" alt="Bronze">
                    </div>
                </div>
            </div>
            ...
            <div class="inside-page">
                <div class="inside-page__container">
                    <h3 class="inside-page__heading inside-page__heading--bronze">
                        For urban lovers
                    </h3>
                    <p class="inside-page__text">
                        As cities never sleep, there are always something going on, no matter what time!
                    </p>
                    <a href="#" class="inside-page__btn inside-page__btn--bronze">View deals</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="card-section">
        <div class="card">
            <div class="flip-card">
                <div class="flip-card__container">
                    <div class="card-front">
                        <div class="card-front__tp card-front__tp--argent">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            viewBox="0 0 60 60" style="enable-background:new 0 0 60 60;" xml:space="preserve" class="card-front__icon">
                        <g>
                        ...
                        <div class="card-front__bt">
                            <p class="card-front__text-view card-front__text-view--argent">
                                En savoir plus
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card-back">
                        <img class="img__container" src="images/gifs/packARGENT.gif" alt="Argent">
                    </div>
                </div>
            </div>
            ...
            <div class="inside-page">
                <div class="inside-page__container">
                    <h3 class="inside-page__heading inside-page__heading--argent">
                        For snow lovers
                    </h3>
                    <p class="inside-page__text">
                        Love snow? Why not take up exciting argent-in sessions and hit the slope? 
                    </p>
                    <a href="#" class="inside-page__btn inside-page__btn--argent">View deals</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="card-section">
        <div class="card">
            <div class="flip-card">
                <div class="flip-card__container">
                    <div class="card-front">
                        <div class="card-front__tp card-front__tp--or">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            viewBox="0 0 60 60" style="enable-background:new 0 0 60 60;" xml:space="preserve" class="card-front__icon">
                        ...
                        <div class="card-front__bt">
                            <p class="card-front__text-view card-front__text-view--or">
                                En savoir plus
                            </p>
                        </div>
                    </div>
                    <div class="card-back">
                        <img class="img__container" src="images/gifs/packOR.gif" alt="Or">
                    </div>
                </div>
            </div>
            ...
            <div class="inside-page">
                <div class="inside-page__container">
                    <h3 class="inside-page__heading inside-page__heading--or">
                        For sun lovers
                    </h3>
                    <p class="inside-page__text">
                        Relax and get sun-kissed tan in the sea or take up surfting for an adventure!
                    </p>
                    <a href="#" class="inside-page__btn inside-page__btn--or">View deals</a>
                </div>
            </div>
        </div>
    </section>
